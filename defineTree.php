...
print "insDoc(foldersTree, gLnk(0, \"Search Nodes\", \"qSearch.html\"))\n";
print "insDoc(foldersTree, gLnk(0, \"Search Customers\", \"ownersView.php\"))\n";

if ($HTTP_SESSION_VARS["keyvalid"]>0){
	print "insDoc(foldersTree, gLnk(0, \"Edit Customers\", \"owners.php\"))\n";
}
print "insDoc(foldersTree, gLnk(0, \"Canopy QOS\", \"Canopy/index.php\"))\n";
print "insDoc(foldersTree, gLnk(0, \"Inactive Nodes\", \"deadnodes.php\"))\n";
print "insDoc(foldersTree, gLnk(0, \"<font color=#cc0000><b>Packet Loss/Latency</b></font>\", \"icmpMonitor.php?graphtype=2&ip=''\"))\n";
